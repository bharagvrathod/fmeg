...
class KPDetector(nn.Module):
    def __init__(self, block_expansion, num_kp, num_channels, max_features, num_blocks, temperature, estimate_hessian=False, scale_factor=1, single_hessian_map=False, pad=0):
